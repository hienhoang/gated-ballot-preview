...
function LoadingContent() {
  ...
  return (
    <div className="bg-white flex justify-center min-h-screen">
      <div className="w-[375px] min-h-[846px] bg-white relative overflow-hidden">
        {/* Background ballot preview at 50% opacity */}
        <div className="absolute top-0 left-0 w-[375px] opacity-50">
          {/* Nav */}
        ...
        <div className="absolute top-[364px] left-0 w-[375px] pl-8 opacity-50 overflow-hidden">
          ...
          <div className="flex gap-2.5 overflow-hidden">
            ...
            <div className="bg-[#f9fafb] rounded-2xl w-[316px] shrink-0 overflow-hidden">
        ...
        {/* Loading overlay */}
        <div
          className="absolute top-0 left-0 w-[375px] h-[846px] flex flex-col items-center justify-center z-10 pointer-events-none"
          style={{
        ...
        >
          <div className="flex flex-col items-center gap-4 px-10">
            ...
            <p className="text-sm leading-5 text-[#403a49] text-center">
